...
const About = () => {
  return (
    <div className=" w-full max-container flex flex-col lg:flex-row justify-center ">
      
      <div className=" hidden lg:block lg:w-[31%] relative group">
        <div className="h-3/4 w-3/4 bg-red-500 absolute top-[-1rem] right-[8rem] transition-all duration-300 group-hover:translate-x-[10px] group-hover:translate-y-4"></div>
        <img
          className="  absolute top-[-7rem] right-[1rem]  transition-all duration-300 group-hover:translate-x-[-10px] group-hover:translate-y-[-5px]"
          src={Image} width={300} alt=""
        />
        <div className="h-48 w-96 border-8 border-white-400 absolute top-4 left-[-10rem] z-0 transition-all duration-300 group-hover:translate-x-2"></div>
      </div>
      ...
      <div className="hidden lg:block lg:w-[31%] relative group">
        <div className="h-3/4 w-3/4 bg-red-500 absolute bottom-[-1rem] left-[8rem] transition-all duration-300 group-hover:translate-x-[10px] group-hover:translate-y-4"></div>
        <img
          className="  absolute bottom-[-7rem] right-[1rem]  transition-all duration-300 group-hover:translate-x-[-10px] group-hover:translate-y-[-5px]"
          src={Image} width={300} alt=""
        />
      </div>
    </div>
