...
const Testimonial = () => {
  ...
  return (
      ...
      <div className=" 
      w-full max-container flex flex-col lg:space-x-6 space-y-4 lg:flex-row flex-wrap relative">
      <div className="hidden lg:block lg:w-[48%] h-full relative">
        {/* Box behind the image */}
        <div className="h-72 w-[30rem] border-4 border-white absolute bottom-[2rem] left-[-10rem] z-0 transition-all duration-300 group-hover:translate-x-2"></div>
      ...
      <div className=" w-full lg:w-[48%] relative">
        <div
          className=" hidden lg:block w-36 h-40 flex justify-center items-center bg-transparent border-2 border-whit-color z-0 top-[-6rem] right-0 absolute "
        >
          <svg
        ...
        <div className=" hidden lg:block h-40 w-40 bg-[#f0f0f0]  absolute bottom-[-5rem] right-5 "></div>
