...
const Clients = () => {
  return (
    <div className="flex justify-center lg:items-center flex-col space-y-4 lg:flex-row  relative text-white p-8">
      ...
      <div
        className=" hidden lg:block w-44 h-[500px] flex justify-center items-center bg-transparent border-4 border-color-[#f0f0f0] z-0 top-[-11rem] right-[-10rem] absolute "
      ></div>
